...
public class ViewAttendanceActivity extends AppCompatActivity implements Callback{
    ...
    private void fetchDetails()
    {
        ...
        NetworkRequest nr = new NetworkRequest(ViewAttendanceActivity.this,mProgressView,mErrorView,this,"get", Urls.server_protocol,Urls.view_attendance_url,params,false,true,0);
    ...
    public void performAction(String result, int tag) {
        try {
            ...
            if (json.getBoolean("success") == true) {
                ...
                ViewAttendanceAdapter mAdapter = new ViewAttendanceAdapter(subjectAttendanceItemsList,getApplicationContext(),ViewAttendanceActivity.this);
